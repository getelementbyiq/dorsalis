...
const RightNavbarOriginal = ({ state }) => {
  const { user } = UserAuth();
    ...
    >
      {rightNav[state].map((navItem, index) => (
        ...
        >
          ...
          <BootstrapTooltip placement="top" title={navItem.nav}>
            <IconButton
              sx={{
                border:
                  rightNavState === navItem.nav
                    ...
                    : "none",
                backgroundColor:
                  rightNavState === navItem.nav ? "#F5F5F5" : "none",
                boxShadow:
                  rightNavState === navItem.nav
              ...
              {navItem.nav === "Crosswords" ? (
                ...
                >
                  <path
                    ...
                    stroke={
                      rightNavState === navItem.nav ? "#292D32" : "#AFAFAF"
                    }
                    stroke-width="1.5"
...
RightNavbarOriginal.propTypes = {};

export default RightNavbarOriginal;
